...
export const SCHEMA = {
  ...
  FAV_MIN:       { v: 0.56,  label: "Price floor",         group: "Edge",    unit: "¢",  step: 0.01, min: 0.30, max: 0.95, pct: true },
  FAV_MAX:       { v: 0.73,  label: "Price cap",           group: "Edge",    unit: "¢",  step: 0.01, min: 0.30, max: 0.95, pct: true },
